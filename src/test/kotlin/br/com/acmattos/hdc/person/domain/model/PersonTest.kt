    ...
    "Feature: Person::class.java usage" - {
        ...
        "Scenario: invalid fullName" - {
            ...
            "Then: instantiation throws exception" {
                assertion.hasSameClassAs(AssertionFailedException(MESSAGE_1,
                    MessageTrackerIdEnum.INVALID_PERSON_FULL_NAME.messageTrackerId))
            }
            "And: exception has messageTrackerId ${MessageTrackerIdEnum.INVALID_PERSON_FULL_NAME.messageTrackerId}" {
        ...
        "Scenario: invalid dob" - {
            ...
            "Then: instantiation throws exception" {
                assertion.hasSameClassAs(AssertionFailedException(MESSAGE_8,
                    MessageTrackerIdEnum.INVALID_PERSON_DOB.messageTrackerId))
            }
            "And: exception has messageTrackerId ${MessageTrackerIdEnum.INVALID_PERSON_DOB.messageTrackerId}" {
                assertion.hasFieldOrPropertyWithValue("code",
                    MessageTrackerIdEnum.INVALID_PERSON_DOB.messageTrackerId)
            }
...
//        }
        ...
        "Scenario: invalid CPF" - {
            ...
            "Then: instantiation throws exception" {
                assertion.hasSameClassAs(AssertionFailedException(MESSAGE_7,
                    MessageTrackerIdEnum.INVALID_PERSON_CPF.messageTrackerId))
            }
            "And: exception has messageTrackerId ${MessageTrackerIdEnum.INVALID_PERSON_CPF.messageTrackerId}" {
                assertion.hasFieldOrPropertyWithValue("code",
                    MessageTrackerIdEnum.INVALID_PERSON_CPF.messageTrackerId)
            }
        ...
        "Scenario: invalid personalId" - {
            ...
            "Then: instantiation throws exception" {
                assertion.hasSameClassAs(AssertionFailedException(MESSAGE_9,
                    MessageTrackerIdEnum.INVALID_PERSON_PERSONAL_ID.messageTrackerId))
            }
            "And: exception has messageTrackerId ${MessageTrackerIdEnum.INVALID_PERSON_PERSONAL_ID.messageTrackerId}" {
                assertion.hasFieldOrPropertyWithValue("code",
                    MessageTrackerIdEnum.INVALID_PERSON_PERSONAL_ID.messageTrackerId)
            }
        ...
        "Scenario: invalid occupation" - {
            ...
            "Then: instantiation throws exception" {
                assertion.hasSameClassAs(AssertionFailedException(MESSAGE_4,
                    MessageTrackerIdEnum.INVALID_PERSON_OCCUPATION.messageTrackerId))
            }
            "And: exception has messageTrackerId ${MessageTrackerIdEnum.INVALID_PERSON_OCCUPATION.messageTrackerId}" {
                assertion.hasFieldOrPropertyWithValue("code",
                    MessageTrackerIdEnum.INVALID_PERSON_OCCUPATION.messageTrackerId)
            }
        ...
        "Scenario: invalid addresses" - {
            ...
            "Then: instantiation throws exception" {
                assertion.hasSameClassAs(AssertionFailedException(MESSAGE_5,
                    MessageTrackerIdEnum.INVALID_PERSON_ADDRESSES.messageTrackerId))
            }
            "And: exception has messageTrackerId ${MessageTrackerIdEnum.INVALID_PERSON_ADDRESSES.messageTrackerId}" {
                assertion.hasFieldOrPropertyWithValue("code",
                    MessageTrackerIdEnum.INVALID_PERSON_ADDRESSES.messageTrackerId)
            }
        ...
        "Scenario: invalid contacts" - {
            ...
            "Then: instantiation throws exception" {
                assertion.hasSameClassAs(AssertionFailedException(MESSAGE_6,
                    MessageTrackerIdEnum.INVALID_PERSON_CONTACTS.messageTrackerId))
            }
            "And: exception has messageTrackerId ${MessageTrackerIdEnum.INVALID_PERSON_CONTACTS.messageTrackerId}" {
                assertion.hasFieldOrPropertyWithValue("code",
                    MessageTrackerIdEnum.INVALID_PERSON_CONTACTS.messageTrackerId)
            }
