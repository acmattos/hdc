 ...
 * @since 29/10/2021.
 */
enum class ErrorTrackerCodeEnum(val code: ErrorTrackerCode) { // TODO Rename to MessageTrackerCode
    SAVE_FAILED(ErrorTrackerCode("01FK69JRHFKTN1BYZW6BRHFZFJ")),
    FIND_BY_FIELD_FAILED(ErrorTrackerCode("01FK69KJ5JKTN1BYZW6BRHFZFJ")),
    FIND_ALL_FAILED(ErrorTrackerCode("01FN4KS8QG9FE3F55670TQCPE3")),
