...
//        context.json(mapOf("version" to "1.0.0-SNAPSHOT"))
    ...
    private fun handleException(context: Context, status:Int, exception: Exception) {
        val errorResponse = createErrorResponse(MessageTrackerId("01FVPVJN7G52MV85FW4ZTYTE6F"),// TODO FIX THIS FOR EACH CASE WITH DIFFERENT ID
            status,
            exception
        )
    ...
    private fun createErrorResponse(code: MessageTrackerId, status: Int, exception: Throwable) =
