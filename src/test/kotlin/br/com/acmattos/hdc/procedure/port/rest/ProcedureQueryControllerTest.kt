 ...
 * @since 30/03/2022.
 */
class ProcedureQueryControllerTest: FreeSpec({
    "Feature: ProcedureQueryController usage" - {
        "Scenario: handling FindAllProceduresQuery successfully" - {
        ...
        "Scenario: handling FindTheProcedureQuery successfully" - {
