...
//    fun apply(events: List<MetaOdontogramEvent>): Odontogram {
//        for (event in events) {
//            apply(event)
//        }
//        return this
//    }
//
//    fun apply(event: MetaOdontogramEvent): Odontogram {
//        when(event) {
...
//        fun apply(events: List<MetaOdontogramEvent>): Odontogram = Odontogram().apply(events)
//        fun apply(event: MetaOdontogramEvent): Odontogram = Odontogram().apply(event)
    }
}
